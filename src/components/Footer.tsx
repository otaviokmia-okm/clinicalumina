    ...
    <footer className="bg-foreground text-background py-16">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="space-y-6">
          ...
          <p className="text-[12px] text-muted-foreground/60 leading-relaxed font-light italic">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-3 text-[10px] font-bold tracking-[0.2em] text-muted-foreground/60 uppercase">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-3 text-[10px] font-medium tracking-widest text-muted-foreground/60">
        ...
        <div className="space-y-6">
          ...
          <p className="text-[10px] text-muted-foreground/60 leading-relaxed">Inscreva-se para receber insights exclusivos.</p>
      ...
      <div className="max-w-7xl mx-auto px-8 pt-10 mt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
        <p className="text-[8px] uppercase tracking-[0.4em] text-muted-foreground/30">
          © 2024 Lumina Aesthetics — Onde a Arte Encontra a Ciência.
        </p>
        <div className="flex gap-8 text-[8px] uppercase tracking-[0.3em] text-muted-foreground/30">
